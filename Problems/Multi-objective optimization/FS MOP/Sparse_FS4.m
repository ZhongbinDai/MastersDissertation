    ...
    methods
        ...
        function PopObj = CalObj(obj,PopDec)
            ...
            for i = 1 : size(PopObj,1)
                ...
                [precision, recall] = getPrecisionAndRecall(obj.ValidOut, Out);
                
                
            	
                PopObj(i,1) = 1-precision;
                PopObj(i,2) = 1-recall;
                PopObj(i,3) = mean(PopDec(i,:));
            end
        end
        %% Display a population in the objective space
        function DrawObj(obj,Population)
%             Draw(Population.objs,{'Ratio of selected features','Validation error',[]});
            Draw(Population.objs,{'1 - precision','1 - recall','Ratio of selected features'});
        end
    end
end